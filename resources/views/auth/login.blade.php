    ...
    <form role="form" action="{{ url('/login') }}" method="POST" autocomplete="false">
        ...
        <div class="container">
            <div class="row">
		    	...
		    	<h1 style="font-weight: bold; text-size: 20px"> Welcome to SMS Inventory Management </h1>

			<img src="{{ url('/') }}/uploads/{{ $snipeSettings->logo }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <fieldset>
                                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                            <form><input class="form-control" placeholder="{{ trans('admin/users/table.username')  }}" name="username" type="text"  autocomplete="off" autofocus></form>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 text-right" style="padding-top: 10px;">
                            ...
                            @else
                                <a style="color: white; text-decoration: underline;" href="{{ route('password.request')  }}">{{ trans('auth/general.forgot_password')  }}</a>
                            @endif
